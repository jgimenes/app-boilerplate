...
export namespace Prisma {
  ...
  */
  ...
  > = {
    AdminAccountAuth?:
      | boolean
      | AdminAccountCountOutputTypeCountAdminAccountAuthArgs;
  };
   ...
   * AdminAccountCountOutputType without action
   */
  export type AdminAccountCountOutputTypeCountAdminAccountAuthArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
  ...
  export type AdminAccountAuthCreateNestedManyWithoutAdminAccountInput = {
    create?:
      ...
      | AdminAccountAuthUncheckedCreateWithoutAdminAccountInput[];
    connectOrCreate?:
      | AdminAccountAuthCreateOrConnectWithoutAdminAccountInput
      | AdminAccountAuthCreateOrConnectWithoutAdminAccountInput[];
    createMany?: AdminAccountAuthCreateManyAdminAccountInputEnvelope;
    connect?:
      | AdminAccountAuthWhereUniqueInput
      | AdminAccountAuthWhereUniqueInput[];
  };
  ...
  export type AdminAccountAuthUpdateManyWithoutAdminAccountNestedInput = {
    ...
    connectOrCreate?:
      ...
      | AdminAccountAuthCreateOrConnectWithoutAdminAccountInput[];
    upsert?:
      | AdminAccountAuthUpsertWithWhereUniqueWithoutAdminAccountInput
      | AdminAccountAuthUpsertWithWhereUniqueWithoutAdminAccountInput[];
    createMany?: AdminAccountAuthCreateManyAdminAccountInputEnvelope;
    ...
    connect?:
      ...
      | AdminAccountAuthWhereUniqueInput[];
    update?:
      | AdminAccountAuthUpdateWithWhereUniqueWithoutAdminAccountInput
      | AdminAccountAuthUpdateWithWhereUniqueWithoutAdminAccountInput[];
    updateMany?:
      | AdminAccountAuthUpdateManyWithWhereWithoutAdminAccountInput
      | AdminAccountAuthUpdateManyWithWhereWithoutAdminAccountInput[];
    deleteMany?:
      | AdminAccountAuthScalarWhereInput
      | AdminAccountAuthScalarWhereInput[];
  };
  ...
  export type AdminAccountAuthCreateManyAdminAccountInputEnvelope = {
    data:
      | AdminAccountAuthCreateManyAdminAccountInput
      | AdminAccountAuthCreateManyAdminAccountInput[];
  };
  ...
  export type AdminAccountAuthUpdateManyWithWhereWithoutAdminAccountInput = {
    ...
    data: XOR<
      AdminAccountAuthUpdateManyMutationInput,
      AdminAccountAuthUncheckedUpdateManyWithoutAdminAccountInput
    >;
  };
