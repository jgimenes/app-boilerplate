...
export namespace Prisma {
  ...
  */
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    accounts<T extends Tenant$accountsArgs<ExtArgs> = {}>(
      args?: Subset<T, Tenant$accountsArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    tenant<T extends Account$tenantArgs<ExtArgs> = {}>(
      args?: Subset<T, Account$tenantArgs<ExtArgs>>
    ): Prisma__TenantClient<
      $Result.GetResult<
        Prisma.$TenantPayload<ExtArgs>,
        T,
      ...
      GlobalOmitOptions
    >;
    auth<T extends Account$authArgs<ExtArgs> = {}>(
      args?: Subset<T, Account$authArgs<ExtArgs>>
    ): Prisma__AuthClient<
      $Result.GetResult<
        Prisma.$AuthPayload<ExtArgs>,
        T,
        'findUniqueOrThrow',
        GlobalOmitOptions
      > | null,
   ...
   * Account.tenant
   */
  export type Account$tenantArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Tenant
  ...
  export type AuthSelectCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      accountId?: boolean;
  ...
  export type AuthSelectUpdateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      accountId?: boolean;
  ...
  export type AuthIncludeCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    account?: boolean | AccountDefaultArgs<ExtArgs>;
  };
  export type AuthIncludeUpdateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    account?: boolean | AccountDefaultArgs<ExtArgs>;
  };
  ...
  type AuthGetPayload<S extends boolean | null | undefined | AuthDefaultArgs> =
    $Result.GetResult<Prisma.$AuthPayload, S>;
  ...
  > {
     ...
     * })
     */
    findUnique<T extends AuthFindUniqueArgs>(
     ...
     * })
     */
    findFirst<T extends AuthFindFirstArgs>(
     ...
     *
     */
    createManyAndReturn<T extends AuthCreateManyAndReturnArgs>(
     ...
     *
     */
    updateManyAndReturn<T extends AuthUpdateManyAndReturnArgs>(
      args: SelectSubset<T, AuthUpdateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$AuthPayload<ExtArgs>,
        T,
     ...
     * })
     **/
    aggregate<T extends AuthAggregateArgs>(
      args: Subset<T, AuthAggregateArgs>
    ): Prisma.PrismaPromise<GetAuthAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, AuthGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetAuthGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
    /**
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export interface Prisma__AuthClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
   ...
   */
  export type AuthCreateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Auth
   ...
   */
  export type AuthUpdateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Auth
  ...
  export type AuthScalarFieldEnum =
    (typeof AuthScalarFieldEnum)[keyof typeof AuthScalarFieldEnum];
  ...
  export type AuthScalarWhereWithAggregatesInput = {
    ...
    otpExpiresAt?:
      | DateTimeNullableWithAggregatesFilter<'Auth'>
      | Date
      | string
      | null;
  ...
  export type TenantCreateNestedOneWithoutAccountsInput = {
    create?: XOR<
      TenantCreateWithoutAccountsInput,
      TenantUncheckedCreateWithoutAccountsInput
    >;
  ...
  export type AuthCreateNestedOneWithoutAccountInput = {
    create?: XOR<
      AuthCreateWithoutAccountInput,
      AuthUncheckedCreateWithoutAccountInput
    >;
  ...
  export type TenantUpdateOneWithoutAccountsNestedInput = {
    ...
    update?: XOR<
      XOR<
        TenantUpdateToOneWithWhereWithoutAccountsInput,
        TenantUpdateWithoutAccountsInput
      >,
      TenantUncheckedUpdateWithoutAccountsInput
    >;
  };
  ...
  export type AuthUpdateOneWithoutAccountNestedInput = {
    ...
    update?: XOR<
      XOR<
        AuthUpdateToOneWithWhereWithoutAccountInput,
        AuthUpdateWithoutAccountInput
      >,
      AuthUncheckedUpdateWithoutAccountInput
    >;
  };
  ...
  export type AccountCreateNestedOneWithoutAuthInput = {
    create?: XOR<
      AccountCreateWithoutAuthInput,
      AccountUncheckedCreateWithoutAuthInput
    >;
  ...
  export type AccountUpdateOneRequiredWithoutAuthNestedInput = {
    ...
    update?: XOR<
      XOR<
        AccountUpdateToOneWithWhereWithoutAuthInput,
        AccountUpdateWithoutAuthInput
      >,
      AccountUncheckedUpdateWithoutAuthInput
    >;
  };
  ...
  export type AccountUpdateManyWithWhereWithoutTenantInput = {
    ...
    data: XOR<
      ...
      AccountUncheckedUpdateManyWithoutTenantInput
    >;
  };
